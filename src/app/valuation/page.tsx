                    ...
                    <div className="max-w-2xl mx-auto bg-gray-50 dark:bg-muted p-8 md:p-12 rounded-sm shadow-sm">
                        <form className="space-y-6">
                            <div className="space-y-2">
                                <label htmlFor="address" className="text-xs uppercase tracking-wider text-gray-500 dark:text-muted-foreground">Property Address</label>
                                <input type="text" id="address" className="w-full bg-background border border-border px-4 py-3 focus:outline-none focus:border-accent transition-colors" placeholder="123 Luxury Lane" />
                            </div>
                            ...
                            <button
                                type="button"
                                className="w-full bg-neutral-900 dark:bg-white text-white dark:text-black px-8 py-4 text-sm uppercase tracking-widest hover:bg-accent dark:hover:bg-accent hover:text-white dark:hover:text-white transition-all duration-300 font-bold shadow-lg mt-4"
                            >
                                Request Valuation
                            </button>
                        </form>
